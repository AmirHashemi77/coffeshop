...
const CustomerReview = () => {
    ...
    const nextBtn=()=>{
        // if(activeCardIndex>=customerReviewArr.length){
    ...
    return (
        <div className='w-full my-16 relative md:my-44 md:py-16'>
            ...
            <div className='max-w-6xl mx-auto relative bg-customer-review'>
                ...
                <div onScroll={(e)=>scrollSlider(e)} ref={slider} className='customer-slider pt-40 relative bottom-0 overflow-y-hidden '>
                  {customerReviews.map((item,index)=>(
                    ...
                    {/* buttons */}
                <button onClick={prevBtn} className='absolute top-1/2 left-10'>
                ...
                <button onClick={nextBtn} className='absolute top-1/2 right-10'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
            ...
            <div className='hidden absolute -top-24 left-0 rotate-180 md:block z-0 -scale-x-100'>
