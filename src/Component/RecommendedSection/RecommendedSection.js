...
import { getSliderProducts } from '../../services/getProduct';
import { useQuery } from '@tanstack/react-query';



const RecommendedSection = ({type}) => {
                    ...
                    <div className='max-w-6xl mx-auto'>
                        <div className='flex flex-col items-center gap-16'>
                            ...
                            <div ref={sliderEl} className='product-slider'>
                                {
                                    products?.map((item)=>(
                                        <SliderCard key={item.id} id={item.id} imgurl={item.photo} title={item.productName} subTitle={item.subTitle} price={`${item.price}$`} cardWidth={cardWidth}/>
                                    ))
                                }
                            </div>
