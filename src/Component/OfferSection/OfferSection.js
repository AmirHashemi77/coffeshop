    ...
    return (
        <div className='w-full my-16 relative md:my-32'>
            <div className='max-w-7xl mx-auto px-7'>
                <div className='w-full card-border-right my-12 mx-auto pt-7 relative bg-card-slider2'>
                        <h4 className='section-title text-shadow absolute z-10 left-11 -top-6 md:text-5xl md:-top-8'>Offer</h4>
                        <div className='flex flex-col-reverse justify-between items-center w-full py-7 px-10 md:flex-row'>
                            ...
                            <img src="/images/product/cea2f73f692d663ab2e2f8cf3ab8cefb.png" alt="product" className='max-w-sm h-80 md2:w-96 object-contain object-center'/>
                        </div>
