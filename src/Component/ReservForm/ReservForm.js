            ...
            <div className='w-full max-w-7xl mx-auto p-7'>
                ...
                <div className='flex flex-col items-center justify-between w-full md:flex-row md:pt-5'>
                    ...
                    <form className='flex flex-col items-center md:grid md:grid-cols-12 gap-x-9 gap-y-8 w-full px-5 mt-10 md:w-2/3'>
                            ...
                            <div className='flex items-center  bg-white w-full border border-[#D6D6D6] rounded-xl px-3 md2:col-start-1 md2:col-end-7'>
                                <img src="/images/icon/ic_round-access-time.svg" alt="" />
                                <input type="text" placeholder='Time' className='form-input'/>
                            </div>
                            <div className='flex items-center  bg-white w-full border border-[#D6D6D6] rounded-xl px-3 md2:col-start-7 md:col-end-13'>
                            ...
                            <div className='flex items-center  bg-white w-full border border-[#D6D6D6] rounded-xl px-3 md2:col-start-1 md2:col-end-8'>
                                <img src="/images/icon/ic_outline-email.svg" alt="" />
                                <input type="text" placeholder='your email' className='form-input'/>
                            </div>
                            <button className='btn rounded-xl py-2 w-full text-[#F8E4BE] font-leiko capitalize bg-btn lg:text-xl lg:px-7 md:w-auto md2:col-start-8 md2:col-end-13'>Reserve</button>
                    </form>
