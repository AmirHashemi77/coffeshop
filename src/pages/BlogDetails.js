                    ...
                    <div className='flex flex-col items-center w-full max-w-5xl bg-card-slider p-5'>
                        {/* blog content */}
                            <div className='w-full flex flex-col items-center gap-5 border-brown1 border-b border-opacity-10 py-5'>
                                <h6 className='text-white text-sm  font-leiko  leading-8 text-center md:text-xl md:leading-8 capitalize'>How To Make A Great Coffee</h6>
                            ...
                            <div className='w-full flex flex-col gap-3 justify-between items-center p-5 max-w-4xl md2:flex-row md2:gap-0'>
                                ...
                                <div className='flex flex-col items-start gap-3'>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <span className='text-white opacity-50 text-xs text-center font-leiko font-normal leading-8 md:text-start md:text-sm md:leading-8'>Amir Hashemi</span>
                                    </div>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <span className='text-white opacity-50 text-xs text-center font-leiko font-normal leading-8 md:text-start md:text-sm md:leading-8'>2024/03/02</span>
                                    </div>
